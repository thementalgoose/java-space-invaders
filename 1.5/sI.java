...
public class sI extends JFrame {
	...
	public sI(int inRows, int numberPerRow1) {
		rows = inRows;
		numberPerRow = numberPerRow1;
		enemyMovementTimer = 8 * timer;
		NPRAR = numberPerRow * rows;
		try {
	...
	public void drawEnemies() {
		...
		for (int i = 0; i < NPRAR; i++) {
			...
			enemies.add(new Enemy(xVals[i], yAxis, z));
		}
	}
